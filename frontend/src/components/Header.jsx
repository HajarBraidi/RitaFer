  ...
  return (
    <header className="bg-black text-white p-4 flex items-center justify-between sticky top-0 z-50">
      ...
      <nav className="space-x-6 text-sm font-semibold flex items-center">
        ...
        <a href="#GAMME DES PRODUITS" className="text-blue-600 hover:underline">GAMME DES PRODUITS</a>
        <a href="#reseaux" className="text-blue-600 hover:underline">RÉSEAUX</a>
